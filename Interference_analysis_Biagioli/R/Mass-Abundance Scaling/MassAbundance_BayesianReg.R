...
#####################################################################################
### CODE WRITTEN BY DR. KYLE COBLENTZ
...
scale_data <- read.csv('/Users/francisbiagioli/Documents/R/Interference/Mass Abundance Scaling/AbundanceScaling.csv')
...
mammal_fit <- brm(formula = log(Density_Nm2) ~ 0 + Intercept + log(Mass_g), data = mammal)
...
protist_fit <- brm(formula = log(Density_Nm2) ~ 0 + Intercept + log(Mass_g), data = protist)
...
invertebrate_fit <- brm(formula = log(Density_Nm2) ~ 0 + Intercept + log(Mass_g), data = invertebrate)
...
ecto_vertebrate_fit <- brm(formula = log(Density_Nm2) ~ 0 + Intercept + log(Mass_g), data = ecto_vertebrate)
...
bird_fit <- brm(formula = log(Density_Nm2) ~ 0 + Intercept + log(Mass_g), data = bird)
...
prokaryote_fit <- brm(formula = log(Density_Nm2) ~ 0 + Intercept + log(Mass_g), data = prokaryote)
